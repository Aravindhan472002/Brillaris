...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-accent text-white dark:bg-gray-950">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div
            ...
            className="bg-white text-accent dark:bg-gray-800 dark:text-gray-100 rounded-xl shadow-lg p-8"
          >
            <h3 className="font-poppins font-semibold text-2xl text-primary dark:text-white mb-6">Send Us a Message</h3>
