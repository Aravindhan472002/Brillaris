  ...
  return (
    <section id="team" className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="font-poppins font-bold text-3xl md:text-4xl text-primary mb-4">Who We Are</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="font-poppins font-semibold text-2xl text-primary mb-6">Our Team</h3>
            ...
            <div className="mb-8">
              <h4 className="font-medium text-xl text-accent mb-3">Our Commitments</h4>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Building trust, igniting creativity, and empowering progress across every industry</span>
                </li>
                <li className="flex items-start">
                  <Gem className="text-secondary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-gray-700">Leading with bold ideas and delivering ethical, sustainable, and future-ready solutions</span>
                </li>
                <li className="flex items-start">
                  <Gem className="text-secondary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-gray-700">Crafting experiences with intention, artistry, and meaning in every project</span>
                </li>
              </ul>
            </div>
            ...
            <motion.div 
              ...
              className="p-6 bg-accent text-white rounded-lg"
            >
